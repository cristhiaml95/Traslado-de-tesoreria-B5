...
# PROCESO -------------------------------------------------------------
    ...
    def getAccountTableChildren(self, account):
        ...
        #     self.rec = self.session.findById('wnd[0]/usr/lbl[37,1]').text
        # except:
        #     noSeSeleccionoPartidaFail = self.session.findById('wnd[0]/sbar/pane[0]').text
        #     noSeSeleccionoPartidaFail = str(noSeSeleccionoPartidaFail)
        #     noSeSeleccionoPartidaFail = noSeSeleccionoPartidaFail[:37]
        #     self.session.EndTransaction()
        #     # writeLog('\n', noSeSeleccionoPartidaFail, self.logPath)
        #     raise Exception(noSeSeleccionoPartidaFail)
